...
<body style="display: flex; align-items:center; flex-direction: column;">
    <div class="container" style="max-width: 1000px;">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="http://localhost:82/static1.html">О нас</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="http://localhost:82/dynamic1.php">Бренды</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost:82/static2.html">Контакты</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row" style="margin-top: 5em;">
            ...
            foreach ($result as $row) {
                ...
                echo "<img src={$row['logo']} class=\"card-img-top mx-auto\" alt=... style=\"width:300px; height: 200px;\">";
                echo "<div class=card-body>";
                echo "<h5 class=card-title>{$row['name']}</h5>";
                echo "<a href=./admin2.php?brand={$row['ID']} class=\"btn btn-primary\">Список авто</a>";
    ...
    <script>
        ...
        function edit(id, name) {
            ...
            if (id) {
                label.innerHTML = "Изменить бренд " + name;
                btn.innerHTML = "Изменить";
                id_ = id;
                name_ = name;
                state = 1;
            } else {
                label.innerHTML = "Добавить бренд";
        ...
        function submit() {
            ...
            if (state == 1) {
                text_.innerHTML = updateBrand(id_, newName.value, newLogo.value);
            } else if (state == 0) {
                text_.innerHTML = addBrand(newName.value, newLogo.value);
            }
